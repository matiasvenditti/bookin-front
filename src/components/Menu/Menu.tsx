...
export class Menu extends React.Component<{ logoutCallback(): void, nowIsLogged: boolean }, {}> {

    // Render knows how to display users information in table format.
    render() {
        return (
            <div>
                <Header logoutCallback={this.props.logoutCallback} nowIsLogged={this.props.nowIsLogged} />
            </div>
        )
    }
